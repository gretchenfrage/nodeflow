...
public class SocketConstants {
	...
	public static final long TRANSMISSION_TYPE_MASK_RANGE = 0xF0000000;
	 ...
	 */
	public static final long PAYLOAD_MASK = 0x00000000;
	/**
	 ...
	 * bytes are payload.
	 */
	public static final long ORDERED_PAYLOAD_MASK = 0x10000000;
	/**
	 * A header-only message for reaching out to start a connection.
	 */
	public static final long START_CONNECTION_MASK = 0x20000000;
	/**
	 * A header-only message for ending a connection.
	 */
	public static final long DISCONNECT_CONNECTION_MASK = 0x30000000;
	/**
	 * A header-only message for accepting a proposed connection.
	 */
	public static final long ACCEPT_CONNECTION_MASK = 0x40000000;
	/**
	 * A header-only message for rejecting a proposed connection.
	 */
	public static final long REJECT_CONNECTION_MASK = 0x50000000;
	/**
	 * A confirmation that a payload has been received. First 8 bytes are
	 * header, next 8 bytes are payload ID.
	 */
	public static final long CONFIRM_PAYLOAD_MASK = 0x60000000;
	/**
	 * A heartbeat that must be sent every HEARTBEAT_INTERVAL.
	 */
	public static final long HEARTBEAT_MASK = 0x70000000;
